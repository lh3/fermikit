...
function unitig_lengths {
	zcat "$1" | awk '{if(NR%4==2) print length($1)}' | sort -nr
}
function N50 {
...
../fermi.kit/fermi2.pl unitig -s30000 -t$(nproc) -l100 -p ARTIFACT_HS1011_rearrangement HS1011_11_1910000_1940000.fastq.gz > ARTIFACT_HS1011_rearrangement.mak
...
# FIXME: Segfaults on: htsbox abreak -cu ARTIFACT_HS1011_rearrangement.unsrt.sam.gz !
#../fermi.kit/run-calling -t$(nproc) ARTIFACT_11_1910000_1940000.fa ARTIFACT_HS1011_rearrangement.mag.gz | bash -ex -o pipefail
