...
aggressive data compression, greatly reducing the efforts and cost on data
storage, distribution and reanalyses at an acceptable cost of information loss.
