...
\begin{table}[t]
\processtable{GIAB evaluation on SNP/INDEL accuracy}
{\footnotesize
...
\botrule
\end{tabular}}{SNP/INDELs were called from the CHM1 (AC:SRR642636 through SRR642641) and NA12878-PG- BWA-MEM
...
against a reference genome. Jointly calling 261 aligned SGDP samples only took
